"use strict";
(self["webpackChunkserver"] = self["webpackChunkserver"] || []).push([[7027],{
...
const useFindRedirectionLink = (slug) => {
  ...
  const collectionTypesMenuLinks = (0,es.useSelector)(useFindRedirectionLink_selectors);
...
const useSyncRbac = (query, collectionTypeUID, containerName = "listView") => {
  const collectionTypesRelatedPermissions = (0,es.useSelector)(selectCollectionTypePermissions);
  const permissions = (0,es.useSelector)(selectPermissions);
